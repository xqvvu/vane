...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-none p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
        bordered: "gap-0 border border-border bg-muted/30 p-0",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=bordered]/tabs-list:border-l-border group-data-[variant=bordered]/tabs-list:bg-transparent group-data-[variant=bordered]/tabs-list:first:border-l-transparent",
