...
export const listConfigurationFn = createServerFn({ method: "GET" })
  ...
  .handler(async ({ context }) =>
    context.dashboardRequest.container.createConfigPortabilityService().listConfiguration(),
  );

export const listDestinationCatalogFn = createServerFn({ method: "GET" })
  .middleware([requireDashboardContextMiddleware])
  .handler(async ({ context }) =>
    context.dashboardRequest.container.createDestinationService().listDestinationCatalog(),
  );

export const listProviderCatalogFn = createServerFn({ method: "GET" })
  .middleware([requireDashboardContextMiddleware])
  .handler(async ({ context }) =>
    context.dashboardRequest.container.createConfigPortabilityService().listProviderCatalog(),
  );
...
export const importConfigurationTomlFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createConfigPortabilityService().importTomlFromCommand(data),
  );
...
export const createSourceFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createSourceService().createSource(data),
  );
...
export const updateSourceFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createSourceService().updateSource(data),
  );
...
export const rotateSourceTokenFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createSourceService().rotateSourceToken(data),
  );
...
export const createDestinationFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createDestinationService().createDestination(data),
  );
...
export const updateDestinationFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createDestinationService().updateDestination(data),
  );
...
export const testDestinationFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createDestinationService().testDestination(data),
  );
...
export const previewDestinationFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createDestinationService().previewDestination(data),
  );
...
export const previewDestinationDraftFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createDestinationService().previewDestinationDraft(data),
  );
...
export const previewDestinationUpdateFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createDestinationService().previewDestinationUpdate(data),
  );
...
export const createRouteFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createRouteService().createRoute(data),
  );
...
export const updateRouteFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createRouteService().updateRoute(data),
  );
...
export const updateAppSettingsFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) =>
    context.dashboardRequest.container.createAppSettingsService().updateAppSettings(data),
  );
